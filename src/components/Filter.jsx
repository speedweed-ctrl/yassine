...
const Filter = () => {
    ...
    const list= [
        { label: 'lorem ipsul', id: 1 },
        { label: 'lorem ', id: 2 },
        { label: 'another one', id: 3 },
        { label: 'also another one', id: 4 },
  ...
  return (
    ...
    />
       ...
       <Grid item>
        <Button variant="contained" sx={{height:'3.5rem' ,width:'10rem' , backgroundColor:'#1ebbd7',marginLeft:'3rem'}}>search</Button>
       </Grid>
    </Grid>
    </Container>
  )
